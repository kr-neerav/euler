...
def get_diagonal_up_right(x:int, y:int) ->int:
    ...
    s = 1
    count = 0
    while x < x_limit and y > 0 and count < 4:
        s = s * get_num_at_pos(x,y)
        count = count + 1
        x = x + 1
        y = y - 1
...
def get_diagonal_down_right(x:int, y:int) ->int:
    ...
    s = 1
    count = 0
    while x < x_limit and y < y_limit and count < 4:
        s = s * get_num_at_pos(x,y)
        count = count + 1
        x = x + 1
        y = y + 1
...
def get_diagonal_down_left(x:int, y:int) ->int:
    ...
    s = 1
    count = 0
    while x > 0 and y > y_limit and count < 4:
        s = s * get_num_at_pos(x,y)
        count = count + 1
        x = x - 1
        y = y + 1
